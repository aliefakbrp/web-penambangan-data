...
st.write("Kelas : 200411100102")
upload_data, preporcessing, modeling, implementation = st.tabs(["Upload Data", "Prepocessing", "Modeling", "Implementation"])


with upload_data:
    st.write("""# Upload File""")
    st.write("Dataset yang digunakan adalah data Klasifikasi Obesitas dari https://www.kaggle.com/code/ekramasif/cardiovasculardiseasepredictionusingml")
