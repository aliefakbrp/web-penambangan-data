...
with implementation:
        ...
        gillattachment=st.text_input('gill-attachment')
        gillspacing=st.text_input('gill-spacing')
        gillsize=st.text_input('gill-size')
        gillcolor=st.text_input('gill-color')
        stalkshape=st.text_input('stalk-shape')
        stalkroot=st.text_input('stalk-root')
        stalksurfaceabovering=st.text_input('stalk-surface-above-ring')
        stalksurfacebelowring=st.text_input('stalk-surface-below-ring')
        stalkcolorabovering=st.text_input('stalk-color-above-ring')
        stalkcolorbelowring=st.text_input('stalk-color-below-ring')
        veiltype=st.text_input('veil-type')
        veilcolor=st.text_input('veil-color')
        ringnumber=st.text_input('ring-number')
        ringtype=st.text_input('ring-type')
