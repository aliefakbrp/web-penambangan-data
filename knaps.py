...
with upload_data:
    ...
    uploaded_files = st.file_uploader("https://raw.githubusercontent.com/08-Ahlaqul-Karimah/machine-Learning/main/healthcare-dataset-stroke-data.csv", accept_multiple_files=True)
